#第二版：
#完整版（先不做刻蚀层，直接做最后刻蚀完的）：
import gdsfactory as gf
from functools import partial
from gdsfactory.generic_tech.layer_map import LAYER
from gdsfactory.technology import LayerLevel, LayerStack, LogicalLayer,AbstractLayer
...
for layername, layer in Si_zp45_LayerStack.layers.items():
    ...
    # print(layername,layer.thickness,layer.material,layer.info.get("refractive_index", "none"),layer.zmin)
...
c = gf.technology.layer_stack.get_component_with_derived_layers(c, Si_zp45_GDS) 
c.show()
# c.to_3d()
s = Si_zp45_LayerStack.get_klayout_3d_script()
print(s)
...
# #这一步是为了在WG上刻蚀器件：
# full_etch = LogicalLayer(layer=(200, 0)).sized((1500, 1500))          
...
#             width_to_z=0.5,
#             derived_layer=layer_core,
#             #derived_layer=LogicalLayer(layer=(200, 0)),   
#             #上述这两种派生层的表示都行
#             #最终计算出来的层，映射到GDS的WG层
#             info={
#                 "refractive_index": 1.4504,
...
#             material="silicon",
#             mesh_order=1,
#             derived_layer=layer_full_etch,
#         ),
    
        # #不包括刻蚀层，直接生成刻蚀完的器件
        # "core":LayerLevel(
        #     layer=layer_Si_Sub ^ ( full_etch ^ layer_core) ,
        #     thickness=thickness_full_etch,
        #     zmin=0,
        #     material="silicon",
        #     mesh_order=2,
...
# c = gf.technology.layer_stack.get_component_with_derived_layers(c, Si_zp45_LayerStack) 
# c.show()
