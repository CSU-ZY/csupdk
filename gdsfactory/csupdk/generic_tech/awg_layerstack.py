...
#打印层栈信息并保存：
#定义保存路径和文件名
output_file = fr"D:\ProgramData\anaconda3\Lib\site-packages\gdsfactory\all_output_files\parameter\Si_zp45_LayerStack.txt"
#打开文件进行写入
...
#无时间戳：
output_gds_path = fr"D:\ProgramData\anaconda3\Lib\site-packages\gdsfactory\all_output_files\gds\{component_name}.gds"
#有时间戳：
